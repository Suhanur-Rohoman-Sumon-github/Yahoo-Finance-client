...
const Sponsars = () => {
    return (
        <Marquee className="grediant">
            ...
            <img className="mx-4" src="https://bitrader.thetork.com/dark/wp-content/uploads/2023/10/barnd01.png" alt="" />
            <img className="mx-4" src="https://bitrader.thetork.com/dark/wp-content/uploads/2023/10/barnd02.png" alt="" />
            <img className="mx-4" src="https://bitrader.thetork.com/dark/wp-content/uploads/2023/10/barnd_dark08.png" alt="" />
